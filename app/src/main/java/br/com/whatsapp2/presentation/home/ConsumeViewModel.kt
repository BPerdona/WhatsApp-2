...
class ConsumeViewModel(private val dao: ChatDao, private val messageDao: MessageDao): ViewModel(){
    ...
    fun getChatLastIndex(): Int{
        Log.e("a", "Tamanho da lista de chats: ${_chats.value?.size}")
...
class ConsumeVMFactory(private val dao: ChatDao, private val messageDao: MessageDao) : ViewModelProvider.Factory{
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if(modelClass.isAssignableFrom(ConsumeViewModel::class.java))
            return ConsumeViewModel(dao, messageDao) as T
